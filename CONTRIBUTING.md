...
- **HDF5** — the bench utilities read ann-benchmarks datasets through the
  system HDF5 library, and they compile as part of any `cargo test`
  (dev-dependency). Install `libhdf5-dev` (Debian/Ubuntu) or `hdf5`
  (Homebrew).
